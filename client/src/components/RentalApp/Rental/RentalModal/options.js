...
export const sexOptionsRO = [
  { value: "man", label: "Bărbat" },
  { value: "woman", label: "Femeie" },
];

export const experienceOptionsRO = [
  { value: "beginner", label: "Incepător" },
...
export const experienceOptionsENG = [
